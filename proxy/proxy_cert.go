...
import "github.com/ttmars/goproxy"

// src\crypto\tls\generate_cert.go 生成的证书不太行。。。
// 使用原项目的证书！ https://github.com/elazarl/goproxy/blob/master/certs.go

var CaCert = goproxy.CA_CERT
var CaKey = goproxy.CA_KEY
